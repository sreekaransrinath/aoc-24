...
"""
- for num in list_1, similarity_score += count(num in list_2) * num
"""

def calc_similarity_score(input_str: str) -> int:
    similarity_score = 0
    list_1, list_2 = parse_input(input_str)
    for num in list_1:
...
print(calc_similarity_score(input_str))